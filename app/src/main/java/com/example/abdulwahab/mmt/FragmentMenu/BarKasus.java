...
Button lihat;
 ...
 String respon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bar_data, container, false);
        rootView.setTag(TAG);
    ...
    private void getData(){
        ...
        StringRequest ibu = new StringRequest(Request.Method.POST, Config.server+"buatgrafikresiko.php", new Response.Listener<String>() {
            @Override
